    ...
    internal class LadderPlayerSnapPatch
    {
        ...
        public static void PatchLadderPlayerSnap(InteractTrigger __instance, ref PlayerControllerB playerController)
        {
            ...
            if (ladderItemScript != null)
            {
                ...
                GiantExtensionLaddersV2.mls.LogDebug("new player pos node: " + __instance.ladderPlayerPositionNode.position);
            }
            else
            {
                GiantExtensionLaddersV2.mls.LogDebug("targeted ladder was not a ladder from this mod");
            }
        }
